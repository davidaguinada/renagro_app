...
class ActividadFilterDropdownMenu extends StatefulWidget {
  final Function(Map<String, List<String>>) onFilterChanged;
  final String userRole;
  final String userName;

  const ActividadFilterDropdownMenu({
    super.key,
  ...
  @override
  ActividadFilterDropdownMenuState createState() => ActividadFilterDropdownMenuState();
}

class ActividadFilterDropdownMenuState extends State<ActividadFilterDropdownMenu> {
  ...
  void loadFilters() {
    setState(() {
      ...
      selectedFilters = {
        ...
        'estado_entrevista': {'Completed', 'RejectedBySupervisor'} // Pre-select Estado options
    ...
    showDialog(
      ...
      builder: (BuildContext context) {
        return CheckboxFilter(
          ...
          fetchFilterOptions: _actividadService.fetchFilterOptions,
